...
// router.get('/getallusers', authenticateUser, userController.getAllUsers); <-- Route that uses auth middleware

// GET route to get all users (not scoped to the authenticated user)
